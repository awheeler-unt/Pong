...
export var paddleSound = new soundFile("paper-page-flip.mp3");
soundArray.push(paddleSound);

export var scoreSound = new soundFile("silence.mp3");
soundArray.push(scoreSound);

export var ambientSound = new soundFile("fireplace sound.mp3");
soundArray.push(ambientSound);
ambientSound.player.loop = true; //turn on looping
ambientSound.player.volume.value = 5; //turn up volume

export var adventureMusic = new soundFile("calming piano music.mp3");
